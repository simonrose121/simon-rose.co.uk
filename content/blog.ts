...
export const posts: Array<BlogPostMeta> = [
	{
		...
		description: 'I read 56 books in 2025. I\'ve written about my favourites, along with some stats from 10 years of beating my one book per week reading target.',
